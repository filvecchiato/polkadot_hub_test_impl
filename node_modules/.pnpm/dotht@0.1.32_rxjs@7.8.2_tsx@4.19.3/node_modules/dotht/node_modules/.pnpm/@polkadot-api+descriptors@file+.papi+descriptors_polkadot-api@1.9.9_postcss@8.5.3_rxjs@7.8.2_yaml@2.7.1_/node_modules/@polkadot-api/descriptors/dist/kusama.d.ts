...
type IStorage = {
    ...
    Parameters: {
         ...
         * Stored parameters.
         */
        Parameters: StorageDescriptor<[Key: Anonymize<I5ps9qbqlvun7q>], Anonymize<Iddckvbdfdasmv>, true, never>;
    };
    Claims: {
        /**
...
type IRuntimeCalls = {
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Iaknq33hc05bq4>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Iaknq33hc05bq4>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I575vh6g119dum>, call: Anonymize<Iaknq33hc05bq4>], Anonymize<I3q0jpjpeplml8>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: KahXcmVersionedLocation, xcm: KahXcmVersionedXcm], Anonymize<Ib7gh0ou2d5j8s>>;
    };
    /**
...
export type KusamaDispatchError = Anonymize<I406br9o9nfug0>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KusamaQueries = QueryFromPalletsDef<PalletsTypedef>;
export type KusamaCalls = TxFromPalletsDef<PalletsTypedef>;
export type KusamaEvents = EventsFromPalletsDef<PalletsTypedef>;
export type KusamaErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type KusamaConstants = ConstFromPalletsDef<PalletsTypedef>;
export type KusamaCallData = Anonymize<Iaknq33hc05bq4> & {
    value: {
        type: string;
    };
};
export type KusamaWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
