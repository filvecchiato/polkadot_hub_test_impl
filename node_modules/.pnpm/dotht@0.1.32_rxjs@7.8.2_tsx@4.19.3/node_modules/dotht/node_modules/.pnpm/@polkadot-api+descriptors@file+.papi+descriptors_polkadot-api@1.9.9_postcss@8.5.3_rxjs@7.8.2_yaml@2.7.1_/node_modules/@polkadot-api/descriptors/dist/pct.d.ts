...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I8l55oo60ovgap>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ifu4ae4s208rno>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<I6nb6jcptm78me>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ifu4ae4s208rno>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I12f6r5plvs0sh>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ifu4ae4s208rno>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I94mh594ndp59c>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Idj5gtjhrllecf>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ibch6kht5imr8g>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Ietl8tjmj464rl>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I3inuji72uvdo3>>;
    };
    Broker: {
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I9bn0adjc806el>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I44ti4iof2qgdo>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I9snm45eebd51b>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I802b96fgd9dvd>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I1h0kh7ntal333>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I802b96fgd9dvd>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I63kbbf0e0o44r>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I9eibd2giu4tl7>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I9eibd2giu4tl7>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<I9eibd2giu4tl7>], Anonymize<I6rm3t6vu6ur6p>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: KahXcmVersionedLocation, xcm: KahXcmVersionedXcm], Anonymize<I8skdub5dr5kml>>;
    };
    /**
...
export type PctDispatchError = Anonymize<I6iir5b1cc0ncm>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PctQueries = QueryFromPalletsDef<PalletsTypedef>;
export type PctCalls = TxFromPalletsDef<PalletsTypedef>;
export type PctEvents = EventsFromPalletsDef<PalletsTypedef>;
export type PctErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type PctConstants = ConstFromPalletsDef<PalletsTypedef>;
export type PctCallData = Anonymize<I9eibd2giu4tl7> & {
    value: {
        type: string;
    };
};
export type PctWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
