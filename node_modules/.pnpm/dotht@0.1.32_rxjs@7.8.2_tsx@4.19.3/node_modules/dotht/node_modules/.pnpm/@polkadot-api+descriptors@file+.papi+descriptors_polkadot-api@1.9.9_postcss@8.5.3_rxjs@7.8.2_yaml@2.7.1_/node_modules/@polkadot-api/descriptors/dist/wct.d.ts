...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I6bj2esarq57fl>, false, never>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I358hgub2ukk5s>>;
        /**
    ...
    BrokerApi: {
         ...
         */
        sale_price: RuntimeDescriptor<[], Anonymize<I531knd64o65mv>>;
    };
    /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Iap7tiv560me91>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Iap7tiv560me91>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I42ficri7uep20>, call: Anonymize<Iap7tiv560me91>, result_xcms_version: number], Anonymize<I4on1nlqkgntu4>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I7bh77bdc58m4f>>;
    };
    /**
...
export type WctDispatchError = Anonymize<I5gu4h8f0am1te>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type WctQueries = QueryFromPalletsDef<PalletsTypedef>;
export type WctCalls = TxFromPalletsDef<PalletsTypedef>;
export type WctEvents = EventsFromPalletsDef<PalletsTypedef>;
export type WctErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type WctConstants = ConstFromPalletsDef<PalletsTypedef>;
export type WctCallData = Anonymize<Iap7tiv560me91> & {
    value: {
        type: string;
    };
};
export type WctWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
