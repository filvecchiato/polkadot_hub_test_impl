...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I1hlvpg2lj4n5s>, false, never>;
        /**
    ...
    Identity: {
         ...
         */
        IdentityOf: StorageDescriptor<[Key: SS58String], Anonymize<I3ruf36ao08o1o>, true, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I3pbb6doqhlilj>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Ifue5rscmspg18>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I3pbb6doqhlilj>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ib7us7q2n5h0gu>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I3pbb6doqhlilj>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I3vh7q80tlk0hq>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ik3lnu56r1nnt>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ibpvr1vvrqtu5r>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I65dleh8ip70nt>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Il16160nlbfbh>>;
    };
    Identity: {
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I9fpov6d3p55u8>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ib2pn7cj2a8mjt>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ie045pa6p0ffrh>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I80goa4fatbh6c>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Im2ctqm5i9u4l>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I80goa4fatbh6c>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I3qkdheercd6dl>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Iplktr33b3d7k>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Iplktr33b3d7k>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<Iplktr33b3d7k>], Anonymize<I55tccq1hakv9c>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: KahXcmVersionedLocation, xcm: KahXcmVersionedXcm], Anonymize<Ie4781qov6lot1>>;
    };
    /**
...
export type PplDispatchError = Anonymize<Iamndt5i5pec5s>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type PplCalls = TxFromPalletsDef<PalletsTypedef>;
export type PplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type PplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type PplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type PplCallData = Anonymize<Iplktr33b3d7k> & {
    value: {
        type: string;
    };
};
export type PplWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
