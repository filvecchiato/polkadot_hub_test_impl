...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Icl9iudeqcbb2u>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<I1fne82af6d4kj>, false, never>;
        /**
    ...
    RemoteProxyRelayChain: {
         ...
         * target chain.
         */
        BlockToRoot: StorageDescriptor<[], Anonymize<Iqnbvitf7a7l3>, false, never>;
    };
    Assets: {
        /**
         * Details of an asset.
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<Icelieq590g1fj>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I8escgcrhk9n2e>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Icelieq590g1fj>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I5hpj2467ae48r>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Icelieq590g1fj>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I7e1mjih78hs55>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Idqso6jjormu5m>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I6a0g4pa89m7ca>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I8oha6hvlae4eg>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I991s7tk2o1idv>>;
    };
    RemoteProxyRelayChain: {
        /**
         ...
         */
        remote_proxy: TxDescriptor<Anonymize<Idmdvqfpf29vuv>>;
        /**
         ...
         */
        register_remote_proxy_proof: TxDescriptor<Anonymize<I9rlr17qfmj0g7>>;
        /**
         *Dispatch the given `call` from an account that the sender is authorised on a remote
         *chain.
         *
         ...
         *- `call`: The call to be made by the `real` account.
         */
        remote_proxy_with_registered_proof: TxDescriptor<Anonymize<I8oha6hvlae4eg>>;
    };
    Assets: {
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Ivreu9kajcsc5>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I4dm2vg3cgi8un>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I1tnsjo5s7hpbs>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I3262tkj7fv5bo>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I84mnvc0radgol>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I3262tkj7fv5bo>>;
        /**
...
type IError = {
    ...
    RemoteProxyRelayChain: {
         ...
         */
        CouldNotConvertLocalToRemoteAccountId: PlainDescriptor<undefined>;
        /**
         *The anchor block of the remote proof is unknown.
         */
        UnknownProofAnchorBlock: PlainDescriptor<undefined>;
        /**
         ...
         */
        ProxyDefinitionDecodingFailed: PlainDescriptor<undefined>;
        /**
         *Announcement, if made at all, was made too recently.
         */
        Unannounced: PlainDescriptor<undefined>;
         ...
         */
        DidNotFindMatchingProxyDefinition: PlainDescriptor<undefined>;
        /**
         *Proxy proof not registered.
         */
        ProxyProofNotRegistered: PlainDescriptor<undefined>;
    };
    Assets: {
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I7rm9ftpuj26h6>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I9pid6leshkemu>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I9pid6leshkemu>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<I9pid6leshkemu>], Anonymize<I26ue8vu0uiuh4>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: KahXcmVersionedLocation, xcm: KahXcmVersionedXcm], Anonymize<I6nou9i5qpe6g8>>;
    };
    /**
...
export type KahDispatchError = Anonymize<I4omsk07tbvmbf>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KahQueries = QueryFromPalletsDef<PalletsTypedef>;
export type KahCalls = TxFromPalletsDef<PalletsTypedef>;
export type KahEvents = EventsFromPalletsDef<PalletsTypedef>;
export type KahErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type KahConstants = ConstFromPalletsDef<PalletsTypedef>;
export type KahCallData = Anonymize<I9pid6leshkemu> & {
    value: {
        type: string;
    };
};
export type KahWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
