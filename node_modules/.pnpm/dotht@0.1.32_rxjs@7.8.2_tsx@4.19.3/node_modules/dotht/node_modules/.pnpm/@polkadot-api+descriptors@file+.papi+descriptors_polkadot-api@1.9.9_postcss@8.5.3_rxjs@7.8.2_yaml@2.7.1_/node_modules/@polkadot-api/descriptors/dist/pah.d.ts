...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: KahXcmVersionedLocation, xcm: KahXcmVersionedXcm], Anonymize<I2dpmmbjqg9tfn>>;
    };
    /**
...
export type PahDispatchError = Anonymize<Icogrvf0inr18b>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PahCallData = Anonymize<I7kclmqit4pj74> & {
    value: {
        type: string;
    };
};
