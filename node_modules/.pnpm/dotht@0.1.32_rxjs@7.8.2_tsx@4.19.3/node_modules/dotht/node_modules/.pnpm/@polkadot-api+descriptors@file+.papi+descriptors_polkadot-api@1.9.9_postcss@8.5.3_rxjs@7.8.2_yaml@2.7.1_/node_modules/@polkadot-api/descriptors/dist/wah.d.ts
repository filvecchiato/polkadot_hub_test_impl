...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I6bv7dj4hklhv0>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<I3jggpqhtc9902>, false, never>;
        /**
         * Freeze locks on account balances.
         */
        Freezes: StorageDescriptor<[Key: SS58String], Anonymize<I88srdm17ahab6>, false, never>;
    };
    TransactionPayment: {
        /**
    ...
    AssetsFreezer: {
         ...
         */
        Freezes: StorageDescriptor<Anonymize<I7svnfko10tq2e>, Anonymize<I88srdm17ahab6>, false, never>;
        /**
    ...
    ForeignAssetsFreezer: {
         ...
         * A map that stores freezes applied on an account for a given AssetId.
         */
        Freezes: StorageDescriptor<Anonymize<I4v5g6i7bmt06o>, Anonymize<I88srdm17ahab6>, false, never>;
        /**
         * A map that stores the current total frozen balance for every account on a given AssetId.
         */
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I60ncu9g93al05>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Ia7p150365ofbr>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I60ncu9g93al05>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ibvn6rkd300koi>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I60ncu9g93al05>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<If2jeh31c7dc1j>>;
        /**
         ...
         *  or both.
         */
        if_else: TxDescriptor<Anonymize<I19cgag7shh6cc>>;
        /**
         *Dispatches a function call with a provided origin.
         *
         ...
         *The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<Ibvn6rkd300koi>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ics0jauch94u7>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I1j0smop13mrrk>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I5o9cg0mkhl27l>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Ia3ue19p5eglt5>>;
    };
    Assets: {
        /**
    ...
    Revive: {
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<Iai3ge79tbfv63>>;
    };
    AssetRewards: {
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I5r53vkfpi84ht>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I6apgv3jf5lls3>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I94i64lcekgj2f>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I26asiqk87b44t>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I5hett2bg1fnha>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I5p1a1fpo3402q>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I26asiqk87b44t>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Id9ta6ebrjtpji>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I42ficri7uep20>, call: Anonymize<Idhl1m6bneg903>, result_xcms_version: number], Anonymize<I7935irqhf33gn>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ibd4all3ej0nk1>>;
    };
    /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Idhl1m6bneg903>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Idhl1m6bneg903>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<Icgfji0ja9av2c>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<Iumo3pjmsjmjv>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<I7n3jto4hu0ttd>>;
        /**
...
export type WahDispatchError = Anonymize<I4umgp8a2i7jfd>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type WahCallData = Anonymize<Idhl1m6bneg903> & {
    value: {
        type: string;
    };
};
