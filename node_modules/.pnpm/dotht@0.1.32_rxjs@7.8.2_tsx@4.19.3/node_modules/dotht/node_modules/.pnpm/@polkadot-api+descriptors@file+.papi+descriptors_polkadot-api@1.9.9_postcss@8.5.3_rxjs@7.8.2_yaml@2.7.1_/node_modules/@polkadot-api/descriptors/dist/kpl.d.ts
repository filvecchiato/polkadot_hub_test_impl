...
export type KplDispatchError = Anonymize<Iamndt5i5pec5s>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KplQueries = QueryFromPalletsDef<PalletsTypedef>;
export type KplCalls = TxFromPalletsDef<PalletsTypedef>;
export type KplEvents = EventsFromPalletsDef<PalletsTypedef>;
export type KplErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type KplConstants = ConstFromPalletsDef<PalletsTypedef>;
export type KplCallData = Anonymize<Iplktr33b3d7k> & {
    value: {
        type: string;
    };
};
export type KplWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
