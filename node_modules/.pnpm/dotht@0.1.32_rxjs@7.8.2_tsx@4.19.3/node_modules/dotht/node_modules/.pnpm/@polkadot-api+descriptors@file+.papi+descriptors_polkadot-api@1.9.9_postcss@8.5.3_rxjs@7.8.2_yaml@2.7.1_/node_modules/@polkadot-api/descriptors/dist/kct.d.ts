...
export type KctDispatchError = Anonymize<I6iir5b1cc0ncm>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type KctQueries = QueryFromPalletsDef<PalletsTypedef>;
export type KctCalls = TxFromPalletsDef<PalletsTypedef>;
export type KctEvents = EventsFromPalletsDef<PalletsTypedef>;
export type KctErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type KctConstants = ConstFromPalletsDef<PalletsTypedef>;
export type KctCallData = Anonymize<I9eibd2giu4tl7> & {
    value: {
        type: string;
    };
};
export type KctWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
